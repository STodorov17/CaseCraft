      ...
      <MaxWidthWrapper className='pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52'>
        <div className='col-span-2 px-6 lg:px-0 lg:pt-4'>
          <div className='relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start'>
            <div className='absolute w-50 -left-5 -top-30 hidden lg:block'>
              <img src="/sitelogo2.png" className='w-full'/>
            </div>
            <h1 className='relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-grey-900 text-5xl md:text-6xl lg:text-7xl'>
              ...
              <div className= 'flex flex-col justify-bettwen items-center sm:items-start'><div className='flex gap-0.5 mt-5 ms-8'>
        ...
        <div className='mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16'>
          <div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
            ...
            <div className='text-lg leading-8'>
              <p>
                "The case feel durable and I even got a compliment on the design. Had the case for two and a ahalf months now and <span className='p-0.5 bg-slate-800 text-white'>the image is super clear</span>, on the case I had before, the image started fading into yellow-ish color after a couple weeks. Love it."
              </p>
            </div>
