    ...
    return (<div className="bg-white">
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
            <div className="max-w-xl">
                ...
                <h1 className="mt-2 text-4xk font-bold tracking-tight sm:text-5xl">Your case is on the way</h1>
            ...
            <div className="mt-10 border-t border-zinc-200">
                <div className="mt-10 flex flex-auto flex-col">
                    ...
                    <p className="mt-2 text-sm text-zinc-600"> We at CaseCraft believe that a phone case doesn't only need to
          ...
          <div className='grid grid-cols-2 gap-x-6 border-t border-zinc-200 py-10 text-sm'>
            ...
            <div>
              ...
              <p className='mt-2 text-zinc-700'>
                Econt, takes up to 2 working days
              </p>
            </div>
          </div>
        </div>
