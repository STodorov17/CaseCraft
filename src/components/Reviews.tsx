...
function ReviewColumn({reviews, className, reviewClassName, msPerPixel = 0}: {
    ...
    return <div ref={columnRef} className={cn('animate-marquee space-y-8 py-4', className)} style={{'--marquee-duration': duration} as React.CSSProperties}>{reviews.concat(reviews).map((imgSrc, reviewIndex) =>(
